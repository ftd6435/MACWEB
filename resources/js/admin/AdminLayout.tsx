        ...
        <div className="min-h-screen bg-[#F8FAFC] flex font-sans selection:bg-[#00B8D4]/30">
            ...
            >
                <div className="p-10 flex items-center justify-between">
                    ...
                    >
                        <img
                            ...
                            alt="Logo"
                            className="h-12 w-auto brightness-0 invert group-hover:scale-110 smooth-animation"
                        />
                    </Link>
                    <button
                    ...
                    {menuItems.map((item) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {isSidebarOpen && (
                                    <span
                                        className={`ml-4 text-sm uppercase tracking-widest font-black ${isActive ? "opacity-100" : "opacity-70 group-hover:opacity-100"}`}
                                    >
                                        {item.label}
                                    </span>
                                )}
                ...
                <div className="p-8 mt-auto">
                    <div
                        className={`bg-white/5 rounded-[2rem] p-6 border border-white/5 ${!isSidebarOpen && "flex justify-center"}`}
                    >
                        {isSidebarOpen ? (
