                ...
                {isLoading ? (
                    <div className="space-y-6">
                        {[1, 2, 3].map((i) => (
                            <div
                                key={i}
                                className="bg-white h-40 rounded-[2.5rem] border border-[#F1F5F9] animate-pulse"
                            />
                        ))}
                    </div>
                ) : (
                            ...
                            >
                                ...
                                <div className="flex-1 text-center md:text-left">
                                    <div className="flex flex-col md:flex-row md:items-center gap-2 mb-3">
                                        <h3 className="text-lg font-black text-[#212121] group-hover:text-[#00B8D4] smooth-animation">
                                            {testimonial.name}
                                        </h3>
                                        ...
                                        <span
                                            className={`inline-flex items-center px-3 py-1 rounded-full text-[8px] font-black uppercase tracking-widest ml-auto ${testimonial.is_active ? "bg-emerald-50 text-emerald-600" : "bg-red-50 text-red-600"}`}
                                        >
